...
api.document.set(
	<Section>
		...
		<Paragraph listItem={{ numbering, depth: 2 }}>List item #3.2.1</Paragraph>
		<Paragraph listItem={{ numbering, depth: 2 }}>List item #3.2.2</Paragraph>
		<Paragraph listItem={{ numbering, depth: 2 }}>List item #3.2.3</Paragraph>
